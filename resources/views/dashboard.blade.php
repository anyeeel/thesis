                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="assets/images/companies/airbnb.svg" alt="" class="avatar-sm">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="assets/images/companies/mailchimp.svg" alt="" class="avatar-sm">
                                            <a href="job-details.html" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="assets/images/companies/reddit.svg" alt="" class="avatar-sm">
                                            <a href="job-details.html" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="assets/images/companies/amazon.svg" alt="" class="avatar-sm">
                                            <a href="job-details.html" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="assets/images/companies/adobe-photoshop.svg" alt="" class="avatar-sm">
                                            <a href="job-details.html" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="assets/images/companies/line.svg" alt="" class="avatar-sm">
                                            <a href="job-details.html" class="text-body">
